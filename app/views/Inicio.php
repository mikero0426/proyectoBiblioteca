    ...
    <div class="form-container">
       ...
       <form method="POST" action="<?php echo URLROOT; ?>Inicio/abrirMenu">
            <div class="group-material-login">
              <input type="text" name="user" class="material-login-control" required="" maxlength="70">
              <span class="highlight-login"></span>
              <span class="bar-login"></span>
              <label><i class="zmdi zmdi-account"></i> &nbsp; usuario</label>
            </div><br>
            <div class="group-material-login">
              <input type="password" name="passwordU" class="material-login-control" required="" maxlength="70">
              <span class="highlight-login"></span>
              <span class="bar-login"></span>
