...
<head>
    ...
    <link rel="Shortcut Icon" type="image/x-icon" href="<?php echo URLROOT;?>icons/book.ico" />
    ...
    <div class="navbar-lateral full-reset">
        ...
        <div class="full-reset container-menu-movile custom-scroll-containers">
            ...
            <div class="full-reset" style="background-color:#2B3D51; padding: 10px 0; color:#fff;">
                <figure>
                    <img src="<?php echo URLROOT;?>img/logo.png" alt="Biblioteca" class="img-responsive center-box" style="width:55%;">
                </figure>
